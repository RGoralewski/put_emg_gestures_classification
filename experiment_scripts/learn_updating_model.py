...
from pegc.training import update_loop
...
@click.argument('model_to_update_file_path', type=click.Path(dir_okay=False, exists=True))
def run_experiment(examinations_prepared_train_test_splits_dir_path: str,
                   results_output_dir_path: str, training_config_file_path: str,
                   model_to_update_file_path: str) -> None:
    ...
    current_model_path = model_to_update_file_path
